            ...
            {user ? (
                !aiResponse ? (
                    <main className='ml-4 mt-24'>
                        <h1 className='text-6xl ml-4 font-bold text-white'>Upload</h1>
                        <div className='text-secondary ml-4 mt-2 text-xl'>
                        ...
                        <div className='flex'>
                            <button className='block bg-secondary px-4 py-2 ml-4 mt-8 rounded text-highlight' onClick={() => router.push("/dashboard")}>Back</button>
                            <button
